...
- 永不提交：`nmi.full.yaml`、`.nodes.hash`、`.Codex/settings.local.json`、`Codex.local.md`、`MEMORY.md`。
...
| `Codex.local.md` | 本机敏感细节（OSS 地址等），gitignored |
...
- 本机操作细节（OSS 地址 / Secrets 清单 / 核对命令）见 `Codex.local.md`。
